...
class Utils {
    ...
    /** Deletes the bytes named FILE if it exists and is not a directory.
     *  Returns true if FILE was deleted, and false otherwise.  Refuses
     *  to delete FILE and throws IllegalArgumentException unless the
     *  directory designated by FILE also contains
     ...
     *  be a normal bytes.  Throws IllegalArgumentException
     *  in case of problems. */
    static byte[] readContents(File file) {
        if (!file.isFile()) {
            throw new IllegalArgumentException("must be a normal bytes");
        }
        try {
    ...
    static byte[] serialize(Serializable obj) {
        try {
            ...
            throw error("Internal error serializing message.");
        }
    }
